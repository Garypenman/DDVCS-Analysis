void ModelFull(FitManager& fm, Int_t Nevents=10000){
  ...
  fm.SetUp().LoadFormula("tau=@mc_Qp2[] / (@mc_s_photo[] - @Mp[]*@Mp[])");
  fm.SetUp().LoadFormula("deltaT2= (-1*@tbot[] * (1-@tau[])) - (@tau[]*@tau[]*@Mp[]*@Mp[])");
  fm.SetUp().LoadFormula("mc_DeltaT=TMath::Sqrt(@deltaT2[])");
  fm.SetUp().LoadFormula("r2=(@mc_s_photo[] - @mc_Qp2[] - @Mp[]*@Mp[])*(@mc_s_photo[] - @mc_Qp2[] - @Mp[]*@Mp[]) - (4*@mc_Qp2[]*@Mp[]*@Mp[])");
  ...
  fm.SetUp().LoadFormula("A3=@tbot[]*(4*@Mp[]*@Mp[]-@tbot[])*@mc_Qp2[]");
  //terms in m_l/L
  fm.SetUp().LoadFormula("sqA4=(@mc_Qp2[]-@tbot[])*(@a[]+@b[]) - (@mc_s_photo[] - @Mp[]*@Mp[])*@b[]");
  ...
  //fm.SetUp().LoadFormula("TCS_TH=(@TCSprefac[]/(4*@mc_Qp2[]))*(1+TMath::Cos(@mc_ThetaHel[])*TMath::Cos(@mc_ThetaHel[]))");
 ...
 //Constrain Total contribution ==1
  ...
  //fm.SetUp().FactoryPDF("BruComponentsPDF::Dilepton(0,{mc_PhiHel,mc_ThetaHel,mc_s_photo,mc_Qp2,mc_t_bot},=BH;BH_TH)");
  
  //BH Only
  //fm.SetUp().FactoryPDF("BruComponentsPDF::Dilepton(0,{mc_GammaPolCirc,mc_PhiHel,mc_ThetaHel,mc_s_photo,mc_Qp2,mc_t_bot,mc_DeltaT},=F1;BHF1A:F1;BHF1B:F2;BHF2A:F2;BHF2B:F1F2;BHF1F2)");
  //fm.SetUp().FactoryPDF("BruComponentsPDF::Dilepton(0,{mc_GammaPolCirc,mc_PhiHel,mc_ThetaHel,mc_s_photo,mc_Qp2,mc_t_bot,mc_DeltaT},=F1;BHF1A)");
  
  //BH+TCS+INT
  //fm.SetUp().FactoryPDF("BruComponentsPDF::Dilepton(0,{mc_GammaPolCirc,mc_PhiHel,mc_ThetaHel,mc_s_photo,mc_Qp2,mc_t_bot,mc_DeltaT},=BH;BH_A1:TCS;TCS_TH:INT;ReM;INT_TH;INT_COSPHI:INT;ImM;INT_TH;INT_hSINPHI)");
