...
vector<std::string> brufit_cols = {"rdfentry_","mc_t_bot","mc_t_top","mc_GammaPolCirc","mc_GammaE","mc_PhiHel","mc_ThetaHel","mc_CosThetaHel","mc_PhiCM","mc_CosThetaCM","mc_Q2","mc_Qp","mc_Qp2","mc_s_photo","mc_DeltaT", "impWeight"};
